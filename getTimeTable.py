...
class Scraper():
    ...
    def setRequestBody(self, year, semester, searchType, name):
    ...
    def scrap(self, year, semester, searchType, name):
        formData = self.setRequestBody(year, semester, searchType, name)
...
if __name__ == "__main__" :
    ...
    name = input("검색명이 무엇입니까?")
    s = Scraper()
    s.scrap(year, semester, searchType, name)